...
public class SmallAndFurryPreferencesController {

    private SmallAndFurryPreferencesView theView;
    private SmallAndFurryPreferencesModel theModel;
    private String id;

    public SmallAndFurryPreferencesController(SmallAndFurryPreferencesView theView, SmallAndFurryPreferencesModel theModel, String _id) {
