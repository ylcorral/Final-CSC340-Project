...
/*
* The purpose of this class to display the HorsesPreferences page
...
public class HorsesPreferencesView extends JFrame {
...
//    private JCheckBox jCheckBoxXLarge = new JCheckBox("XLarge");
    ...
    public HorsesPreferencesView() {
        setTitle("Horse Preferences");
