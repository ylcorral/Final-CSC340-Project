 ...
 * @author biscu
 */
public class HorsesPreferencesController {

    private HorsesPreferencesView theView;
    private HorsesPreferencesModel theModel;
    private String id;

    public HorsesPreferencesController(HorsesPreferencesView theView, HorsesPreferencesModel theModel, String _id) {
