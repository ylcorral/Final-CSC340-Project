...
/*
* The purpose of this class to display the BarnyardPreferences page
...
public class BarnyardPreferencesView extends JFrame {
...
//    private JCheckBox jCheckBoxXLarge = new JCheckBox("XLarge");
    ...
    public BarnyardPreferencesView() {
        setTitle("Barnyard Preferences");
